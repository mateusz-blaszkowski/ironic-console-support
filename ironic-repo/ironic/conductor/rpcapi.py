...
class ConductorAPI(object):
    ...
    |    1.34 - Added get_console_log and clear_console_log
    ...
    def get_console_log(self, context, node_id, topic=None):
        """Get the content from a console log file of the node.
        ...
        :raises: MissingParameterValue if a required parameter is missing
        :returns: a dictionary containing the content type like MIME and
                  a part of the console log text.
        """
        cctxt = self.client.prepare(topic=topic or self.topic, version='1.32')
        return cctxt.call(context, 'get_console_log', node_id=node_id)

    def clear_console_log(self, context, node_id, topic=None):
        """Clear the content of a console log file of the node.
        ...
        """
        cctxt = self.client.prepare(topic=topic or self.topic, version='1.32')
        return cctxt.cast(context, 'clear_console_log', node_id=node_id)
